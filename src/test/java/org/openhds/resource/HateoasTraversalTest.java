...
public class HateoasTraversalTest extends AbstractRestControllerTest {
    ...
    public void followLinks() throws Exception {
        ...
        String insertByUrl = getAndExtractJsonPath(oneLocationUrl, "$._links.insertBy.href");

        // find the user's "self"
        String insertBySelfUrl = getAndExtractJsonPath(oneLocationUrl, "$._links.self.href");
